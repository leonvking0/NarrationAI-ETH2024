...
export const WalletProviderContext = createContext<IWalletProviderContext>({} as IWalletProviderContext)
...
export const WalletProvider: React.FC<PropsWithChildren> = ({ children }) => {
    ...
    useEffect(() => {
        ...
        console.log("read savedSelectedWalletRdns:" + savedSelectedWalletRdns);
    ...
    const contextValue: IWalletProviderContext = {
        wallets,
